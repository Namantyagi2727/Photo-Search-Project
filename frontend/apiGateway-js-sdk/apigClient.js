...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://7ddf84aykc.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'bucket', 'Content-Type', 'Accept', 'customLabels'], ['body']);
    ...
    apigClient.proxyOptions = function (params, body, additionalParams) {
        ...
        var proxyOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/{proxy+}').expand(apiGateway.core.utils.parseParametersToObject(params, ['proxy'])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
